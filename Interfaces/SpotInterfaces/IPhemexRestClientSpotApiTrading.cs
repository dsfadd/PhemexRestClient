...
namespace PhemexClient.Interfaces.SpotInterfaces
{
    public interface IPhemexRestClientSpotApiTrading
    {
        ...
        public Task<WebCallResult<PhemexDataCollection<PhemexSpotOrderByID>>> GetOrderByIDAsync(string symbol, string? orderID = null, string? clOrdID = null, CancellationToken cancellationToken = default);
    }
}